...
\begin{block}{INTRODUCTION}
  ...
  \heading{DAOS Storage System}
    ...
    \begin{figure}
      \centering
        \includegraphics[width=\dimexpr 7\colwidth/8\relax]{diagrams/daos_hierarchy_colored.pdf}
    ...
    \begin{figure} 
      \centering
        \includegraphics[width=\dimexpr 7\colwidth/8\relax]{diagrams/daos_arch_recolored.pdf}
        \label{fig:posix}
  ...
  operated under contract DE-AC02-06CH11357. This work was supported by NSF OAC-2348350 and the Laboratory Directed Research and Development Program at Thomas Jefferson National Accelerator Facility for the U.S. Department of Energy.
  \end{block}
...
\nocite{*}
\tiny{\bibliographystyle{plainnat}\bibliography{poster}}
\end{block}
